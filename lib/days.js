...
function Days() {
  ...
  // emit "prev"
  this.el.querySelector('.prev').addEventListener('click', function(ev){
    ev.preventDefault();
  ...
  // emit "next"
  this.el.querySelector('.next').addEventListener('click', function(ev){
    ev.preventDefault();
...
Days.prototype.yearMenu = function(from, to){
  ...
  var self = this;
  this.title.querySelector('.year .calendar-select').addEventListener('change', function(){
    self.emit('year');
    return false;
  });
};
...
Days.prototype.monthMenu = function(){
  ...
  var self = this;
  this.title.querySelector('.month .calendar-select').addEventListener('change', function(){
    self.emit('month');
    return false;
  });
};
